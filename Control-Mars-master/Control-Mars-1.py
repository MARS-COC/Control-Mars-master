...
if str(platform.system()) == 'Linux':
      os.system('figlet Control-Mars DDoS Attack')
else:
    os.system('pyfiglet Control-Mars  DDoS Attack')

print(Back.GREEN + Fore.GREEN +'[+] Control-Mars tool by' + Fore.RED + 'Anonymous Syrian society                              ') 
print(Back.GREEN + Fore.BLACK + '[+] Control-Mars Tool BETA VERSION 0.1                                             ')
print(Back.BLACK +Fore.GREEN + '[+] Control-Mars Tool Interactive Menu in Python by MARSH                         ')
print(Fore.YELLOW + '[+] We are Anonymous, We are a Legion, We do not Forgive, We do not Forget                            ')
print(Fore.GREEN + '[+] Starting Control-Mars DoS Tool with 1024 Baseline Threads as Default change below as Required           ')
print(Fore.BLUE + 'instagram: ' + Fore.GREEN + 'https://www.instagram.com/mars_coc/)')
print(Fore.RED + 'Youtube: ' + Fore.GREEN + 'https://www.youtube.com/@mars-coc/')
print(Fore.YELLOW + 'GitHub: ' + Fore.GREEN + 'https://github.com/MARS-COC')
